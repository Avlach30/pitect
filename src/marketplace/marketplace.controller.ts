...
export class MarketplaceControllers {
  ...
  async createService(
    ...
    @Body('infoDuration1') infoDuration1: string,
    @Body('infoCost1') infoCost1: string,
    @Body('infoTitle2') infoTitle2: string,
    @Body('infoContent2') infoContent2: string,
    @Body('infoDuration2') infoDuration2: string,
    @Body('infoCost2') infoCost2: string,
    @Body('infoTitle3') infoTitle3: string,
    @Body('infoContent3') infoContent3: string,
    @Body('infoDuration3') infoDuration3: string,
    @Body('infoCost3') infoCost3: string,
  ) {
